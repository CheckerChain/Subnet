...
def get_db_connection():
    ...
    conn.row_factory = sqlite3.Row  # Enable dictionary cursor for better readability (optional)
    return conn
...
def add_product(_id, name, trust_score=0, check_chain_review_done=False, mining_done=False, rewards_distributed=False):
    """Adds a product to the database."""
    execute_query("""
        INSERT INTO products (_id, name, trust_score, check_chain_review_done, mining_done, rewards_distributed)
        VALUES (?, ?, ?, ?, ?)
    """, (_id, name, trust_score, check_chain_review_done, mining_done, rewards_distributed), commit=True)
...
def add_prediction(product_id, miner_id, prediction):
    ...
    execute_query("""
        ...
        VALUES (?, ?, ?)
    """, (product_id, miner_id, prediction), commit=True)
...
def update_product_status(_id, check_chain_review_done=None, mining_done=None, rewards_distributed=None, trust_score=0):
...
def get_a_product(check_chain_review_done=None, mining_done=None, rewards_distributed=None):
...
if __name__ == "__main__":
    ...
    add_product('P001', 'Product 1', check_chain_review_done=True, mining_done=False, rewards_distributed=True)
    add_product('P002', 'Product 2', check_chain_review_done=False, mining_done=True, rewards_distributed=False)
